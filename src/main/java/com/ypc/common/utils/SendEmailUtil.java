...
public class SendEmailUtil {
    ...
    private static String myEmailName = "";
    private static String myEmailPassword = "";
    // 收件人
    public static String to = "";

    public static String[] receierAddr = {""};
    ...
    public static boolean sendTextEmail(String[] to,String subject,String content) throws Exception {
        try {
            if (to != null && to.length > 0 && StringUtils.hasText(subject)
                ...
                //message.setContent("TEST这是邮件正文。。。"+content, "text/html;charset=UTF-8");
                // 设置纯文本内容为邮件正文
                ...
                // 打开连接
                transport.connect(myEmailName, myEmailPassword);
    ...
    *//**
    ...
    public static void main(String[] args) throws Exception {
        sendTextEmail(receierAddr, "测试","程序发送邮件测试。");
    }
