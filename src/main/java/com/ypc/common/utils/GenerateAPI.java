...
public class GenerateAPI {
    ...
    public static void main(String[] args) {
        //返回参数
        /*JSONObject outPropertyRemark = getPropertyRemark(TestQuery.class);
        JSONArray outParamArry = getParamObj(TestQuery.class,outPropertyRemark);*/
        /*getApiDOCleverJsonPost();
        System.out.println(outParamArry.toJSONString());*/
    }
}
