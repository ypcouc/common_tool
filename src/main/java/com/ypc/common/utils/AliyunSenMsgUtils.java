...
/**
 * @ClassName AliyunSenMsgUtils
 * @Description TODO
 * @Author JWD
 * @Date 2018/10/25
 * @Version 1.0
 **/
public class AliyunSenMsgUtils {
    ...
    public static Boolean sendSms(String phone,String content) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("极维度");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_149095912");
        ...
        String srt = sendSmsResponse.getCode();
        if(srt.equals("OK")){
            result = true;
        }
        return result;
