...
//          }  
    ...
    private String parse() {
        ...
        sb.append(newLine3);
        //导包
        /*sb.append("import com.jwd.base.common.codeGenerator.mapperXml.annotations.GenColumn;");
        sb.append(newLine);
        sb.append("import com.jwd.base.common.codeGenerator.mapperXml.annotations.GenTable;");
        sb.append(newLine);*/
        sb.append("import com.jwd.base.common.pojo.CommonInfo;");
        /*sb.append(newLine);
    ...
    private void genQuery() {
        ...
        sb.append(newLine3);
        //导包
        sb.append("import com.jwd.base.common.pojo.query.CommonQuery;");
        sb.append(newLine2);
        //注释部分
        sb.append("/**" + newLine);
