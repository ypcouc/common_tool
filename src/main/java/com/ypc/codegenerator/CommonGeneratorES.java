...
import com.ypc.utils.CharUtils;
...
public class CommonGeneratorES {
    ...
    public String generatorService(String packagePath, String filename, String moduleName) {
        ...
        try {
            ...
            sb.append("import com.jwd.base.common.utils.html.UpdateReturnJson;");
            sb.append(newLine);
    ...
    public String generatorServiceImpl(String packagePath, String filename, String moduleName) {
        ...
        try {
            ...
            sb.append("import com.jwd.base.common.utils.BeanToolUtils;");
            sb.append(newLine);
            sb.append("import com.jwd.base.common.utils.UuidUtils;");
            sb.append(newLine);
            sb.append("import com.jwd.base.common.utils.DateUtils;");
            sb.append(newLine);
    ...
    public String generatorController(String packagePath, String filename, String moduleName) {
        ...
        try {
            ...
            sb.append(newLine);
            sb.append("import com.jwd.base.common.utils.html.DataTablesParam;");
            sb.append(newLine);
            /*sb.append("import com.jwd.base.common.utils.html.DataTablesReturnJSON;");
            sb.append(newLine);
            sb.append("import com.jwd.base.common.utils.html.DataTablesReturnObj;");*/
            sb.append("import com.jwd.base.common.utils.sql.MyPageInfo;");
            sb.append(newLine);
            sb.append("import org.springframework.util.StringUtils;");
            sb.append(newLine);
            sb.append("import org.springframework.data.domain.Page;");
